		  ...
		  if(browser.equalsIgnoreCase("Chrome")) {
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\riaz_\\git\\repository32\\AutomationPractice14\\src\\Drivers\\chromedriver.exe");
			 ...
			 driver.manage().window().maximize();
				 ...
				 System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository32\\AutomationPractice14\\src\\Drivers\\msedgedriver.exe");
...
public void shots() throws IOException {
	  ...
	  FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository32\\AutomationPractice14\\Pictures\\"+sd+"pictureOfWebSite.jpg"));
